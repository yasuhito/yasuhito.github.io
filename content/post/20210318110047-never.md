...
## このノートの TODO {#このノートの-todo}


### <span class="org-todo todo NEXT">NEXT</span> Anki カードに起こす {#anki-カードに起こす}


### <span class="org-todo todo TODO">TODO</span> Anki カードを Anki 上でレビュー {#anki-カードを-anki-上でレビュー}


### <span class="org-todo todo TODO">TODO</span> void のレッスンを書き直す {#void-のレッスンを書き直す}


### <span class="org-todo todo TODO">TODO</span> Anki カードのうち、void に移したほうがよいものを移動 {#anki-カードのうち-void-に移したほうがよいものを移動}


### <span class="org-todo todo TODO">TODO</span> Orbit で SRS を解説文に埋め込む {#orbit-で-srs-を解説文に埋め込む}
