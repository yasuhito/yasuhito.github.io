...
<https://www.executeprogram.com/courses/typescript/lessons/never>
...
この関数の戻り値の型はどうすればよいでしょうか？ TypeScript は、この関数の戻り値の型を `void` と推測します。しかし、これでは何が起こっているのか完全には把握できていません。
